...
newton(1.6,0.6) # converges in 9 iteration
...
Using (0, -1) as starting value results in finding a minimum. It is even global minimum, referring to the contour plot. (3,2) gives a minimum as well, but only a local one. The function converges as well when starting with (1.6, 0.6) but does only find the saddle point between the two minima. 
