...
Using (0, -1) as starting value results in finding a minimum. It is even global minimum, referring to the contour plot. (3,2) gives a minimum as well, but only a local one. Starting with (3,2) does not converge as the algorithm was stopped at the maximum of 1000 iterations, it diverges.
